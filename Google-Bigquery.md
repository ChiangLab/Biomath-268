...
![Cloud settings](./cloud-setup.png)
...
![MIMIC-III demo](./mimic-iii-demo.png)
- For additional details see the following [guide](https://mimic.mit.edu/docs/gettingstarted/cloud/link/)
...
- For additional details see the following [guide](https://mimic.mit.edu/docs/gettingstarted/cloud/bigquery/)
